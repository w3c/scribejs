...
`;
            ...
            // TODO: "lonely if" -- can jekyll and pandoc be used together?
    ...
    function generate_content_md(lines) {
        ...
        */
        ...
        function add_toc(content, level) {
            ...
            let id = '';
            if (level === 1) {
                // TODO: un plusplus this...it's most confusing
        ...
        */
        ...
        _.forEach(lines, (line_object) => {
            ...
            if (label !== null && label.toLowerCase() === 'topic') {
                ...
                // TODO: "lonely if" -- consider refactoring
        ...
        if (rcounter > 1) {
            ...
            // TODO: un pluplus this...most confusing
