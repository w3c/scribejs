 ...
 * @param {actions} - the class handling actions
...
`;
        ...
        */
        ...
        function add_action(content) {
            ...
            if (action_list !== undefined) {
                action_list.add_action(words[0], words.slice(2).join(' '), `${id}`);
            }
        }
    ...
    // 4. Store the actions, if the separate action list handler is available
    if (action_list !== undefined) {
