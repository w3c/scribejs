...
exports.to_markdown = (body, config) => {
    ...
    function cleanup(body_to_clean) {
        ...
        return _.chain(split_body)
            ...
            // 2018-10-29: I have removed this feature. It did more harm than good (many people 'lurk' into
            // an IRC, and these created a number of false positives). Such lines are simply removed.
            .filter((line_object) => {
